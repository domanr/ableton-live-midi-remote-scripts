...
class MIDI_Mix_super(ControlSurface):   # Make sure you update the name
    __doc__ = " Script for MIDI_Mix_super in APC emulation mode "   # Make sure you update the name
    ...
    def _combine_active_instances():
        track_offset = 0
        scene_offset = 0
        for instance in MIDI_Mix_super._active_instances:   # Make sure you update the name
    ...
    def _do_combine(self):
        if self not in MIDI_Mix_super._active_instances:    # Make sure you update the name
            MIDI_Mix_super._active_instances.append(self)   # Make sure you update the name
            MIDI_Mix_super._combine_active_instances()  # Make sure you update the name

    def _do_uncombine(self):
        if (self in MIDI_Mix_super._active_instances) and MIDI_Mix_super._active_instances.remove(self):    # Make sure you update the name
